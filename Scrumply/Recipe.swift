...
class Recipe {
    ...
    // Mark: Methods
    init(name: String, ingredients: [String], steps: [String], mealType: String, servingSize: Int, cookTime: String, image: String, rating: Int) {
        self.name = name
...
//        aCoder.encode(mealType, forKey: PropertyKey.mealType)
//        aCoder.encode(servingSize, forKey: PropertyKey.servingSize)
//        aCoder.encode(cookTime, forKey: PropertyKey.cookTime)
